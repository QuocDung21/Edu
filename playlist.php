   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>Lưu playlist</span></button>
            <?php
               }
            ?>
         </form>
      ...
      <?php
            ...
            echo '<p class="empty">Playlist này không tồn tại!</p>';
         }  
      ?>
...
<!-- Phần playlist kết thúc -->

<!-- Phần videos container bắt đầu -->

<section class="videos-container">

   <h1 class="heading">Các video trong playlist</h1>
   ...
   <div class="box-container">
      ...
      <?php
            ...
            echo '<p class="empty">Chưa có video được thêm vào!</p>';
         }
      ?>
...
<!-- Phần videos container kết thúc -->

<?php include 'components/footer.php'; ?>

<!-- Liên kết tập tin JavaScript tùy chỉnh -->
