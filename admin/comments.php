...
<section style="height:100vh" class="comments">
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['tutor_id'] == $tutor_id){echo 'order:-1;';} ?>">
         <div class="content"><span><?= $fetch_comment['date']; ?></span><p> - <?= $fetch_content['title']; ?> - </p><a href="view_content.php?get_id=<?= $fetch_content['id']; ?>">Xem nội dung</a></div>
      ...
      <?php
         ...
         echo '<p class="empty">Chưa có bình luận được thêm!</p>';
      }
      ?>
      </div>
