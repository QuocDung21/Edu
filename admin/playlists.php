...
if(isset($_POST['delete'])){
   ...
   $message[] = 'danh sách phát đã được xóa!';
   }else{
      $message[] = 'danh sách phát đã được xóa từ trước!';
   }
}
...
<section style="height:100vh" class="playlists">

   <h1 class="heading">Danh sách các danh sách phát</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Xóa" class="delete-btn" onclick="return confirm('Xóa danh sách phát này?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Xem danh sách phát</a>
      </div>
      <?php
         } 
      }else{
         echo '<p class="empty">Chưa có danh sách phát được thêm vào!</p>';
      }
      ?>
