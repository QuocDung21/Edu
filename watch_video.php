...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="Vui lòng nhập bình luận của bạn" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
         <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">Hủy chỉnh sửa</a>
         <input type="submit" value="Cập nhật ngay" name="update_now" class="inline-btn">
      </div>
   </form>
</section>
<?php
...
<section class="comments">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment_box" required placeholder="Viết bình luận của bạn ở đây..." maxlength="1000" cols="30" rows="10"></textarea>
      <input type="submit" value="Thêm bình luận" name="add_comment" class="inline-btn">
   </form>

   <h1 class="heading">Bình luận của người xem</h1>
